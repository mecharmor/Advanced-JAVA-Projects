...
public class CodeTable {
    ...
    //Confirms that this instruction is allowed to have a label
    public static boolean validLabelByteCode(String byteCode){
        /**
         * Helper method for resolveAddrs() in Program.java
         * Validates correct ByteCode for address resolution
         */
        String[] valid = {"FALSEBRANCH", "GOTO", "CALL"};
        for(int i = 0; i < valid.length; i++){
            if(valid[i].equalsIgnoreCase(byteCode)){
                return true;
            }
